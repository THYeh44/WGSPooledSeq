...
#' @param 1) Input the original VEP .txt file generated from Ensembl, 2) Input the SIFT .csv file generayed from SIFT 4G, and 3) Name the output file.
#' @keywords mutations density, deleterious ratio, KS p-value
#' @export
#' @examples
#' pooled_analysis()

pooled_analysis <- function(raw_VEP, SIFT_file, output){
  library(dplyr)
